...
type LearningGroupStatus string

const (
	LearningGroupStatusActive   LearningGroupStatus = "active"
	LearningGroupStatusInactive LearningGroupStatus = "inactive"
)
...
type LearningGroup struct {
	...
	Status        LearningGroupStatus `gorm:"type:varchar(20);default:'active'" json:"status"`
